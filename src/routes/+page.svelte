...
<div class="container mx-auto px-4 py-8">
	<div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
		<div class="bg-vsc-light-bg-medium dark:bg-vsc-bg-medium border border-vsc-light-border dark:border-vsc-border-light rounded-lg p-6 hover:bg-vsc-light-bg-light dark:hover:bg-vsc-bg-light transition-colors">
			<h2 class="text-2xl font-semibold mb-4 text-vsc-light-text-primary dark:text-vsc-text-primary">📔 Python Notepads</h2>
		...
		<div class="bg-vsc-light-bg-medium dark:bg-vsc-bg-medium border border-vsc-light-border dark:border-vsc-border-light rounded-lg p-6 hover:bg-vsc-light-bg-light dark:hover:bg-vsc-bg-light transition-colors">
			<h2 class="text-2xl font-semibold mb-4 text-vsc-light-text-primary dark:text-vsc-text-primary">🗂️ Codebase Browser</h2>
			<p class="text-vsc-light-text-secondary dark:text-vsc-text-secondary mb-4">
	...
	<div class="text-center mt-12">
		<p class="text-vsc-light-text-secondary dark:text-vsc-text-secondary">
			A local-first web application built with SvelteKit and designed with VS Code aesthetics
		</p>
	</div>
</div>
